...
<body>
	<%
		...
		if(request.getParameter("item_code_form") == "" ||
			...
			/* // 데이터 확인용 출력
			System.out.println("============== stock_itemEditAction 데이터 =================");
			System.out.println("item_code : " + item_code);
			System.out.println("item_name : " + item_name);
			System.out.println("item_standard : " + item_standard);
			System.out.println("item_unit_name : " + item_unit_name);
			System.out.println("item_unit_price : " + item_unit_price);
			System.out.println("item_original_price : " + item_original_price); */
			
			cnt = -1;
			try{
				// DB에 등록
				StockDAO stockDAO = new StockDAO();
				cnt = stockDAO.itemEdit(item_code, item_name, item_standard, item_unit_name, item_unit_price, item_original_price);
			} catch(Exception e){
				System.out.println("DB 등록 중 예외 발생 -> : " + e);
			}
