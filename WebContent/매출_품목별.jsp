...
<body id="page-top" onload="noBack();" onpageshow="if(event.persisted) noBack();" onunload="">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content : 품목별 매출 현황 페이지 시작-->
				<div class="container-fluid">

					<!-- 상단바 -->
					<nav class="navbar navbar-dark bg-primary">
						<div class="container-fluid">
							<a class="navbar-brand mb-0 h1" href="#">품목별 매출 현황</a>
						</div>
					</nav>
            ...
            String code_search = (String)request.getParameter("item_code_search");
            String name_search = (String)request.getParameter("item_name_search");
            ...
            %>
				...
				<!-- 검색창 -->
				<form action="매출_품목별.jsp" method="POST">
				<div class="row mt-3 ml-1">
				    <div class="col-lg-4">
					    <div class="input-group">
					      <span class="mt-2" style="width:100px">품목코드</span>
					      <div class="input-group-btn m-1">
							 <input type="text" name="item_code_search" value="<%=code_search_value %>" class="form-control-sm ml-2" aria-describedby="basic-addon2">
						  </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
					<div class="col-lg-4">
					    <div class="input-group">
					       ...
					       <div class="input-group-btn m-1">
							 		<select name="item_name_search" class="form-control ml-1" style="width: 150px">
                ...
                <div class="row mt-2 ml-1">
					    ...
					    <div class="input-group" style="width:900px">
					      ...
					      <div class="form-group m-1"> 
						      <div class="input-group date mt-1 ml-2"> 
								<input type="text" name="source_datepicker_search" value="<%=sourcePicker_value %>" class="datepicker" style="width:175px" id="sale_list_datepicker_5"> 
						      </div> 
					      </div>
					      <span class="mt-1 ml-3">~</span>
					      <div class="form-group m-1"> 
						      <div class="input-group date mt-1 ml-2"> 
								<input type="text" name="destination_datepicker_search" value="<%=destinationPicker_value %>" class="datepicker" style="width:175px" id="sale_list_datepicker_6"> 
						      </div> 
					      </div>
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
					...
					<!-- 확인 버튼 -->
					<div class="col-2" > 
						<button type="submit" style="margin-left:117px;" id="sale_total_data-submit-button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1">확인</button>
					</div>
                </div>
                </form>
               </div>
							...
							<div class="table100" style="width:100%; height:450px; overflow:auto">
								<table>
									<thead>
										<tr class="table100-head">
											<th class="sales_item1" rowspan=2>No</th>
											<th class="sales_item2" rowspan=2>품목<br>코드</th>
											<th class="sales_item3" rowspan=2>품목명</th>
											<th class="sales_item4" rowspan=2>전표<br>번호</th>
											<th class="sales_item5" rowspan=2>매출일</th>
											<th class="sales_item6" colspan=2>담당자</th>
											<th class="sales_item7" rowspan=2>거래처<br>코드</th>
											<th class="sales_item8" rowspan=2>거래처명</th>
											<th class="sales_item9" rowspan=2>단위</th>
											<th class="sales_item10" rowspan=2>수량</th>
											<th class="sales_item11" rowspan=2>단가</th>
											<th class="sales_item12" rowspan=2>공급<br>가액</th>
											<th class="sales_item13" rowspan=2>세액</th>
											<th class="sales_item14" rowspan=2>매출액</th>
											<th class="sales_item16" rowspan=2>비고</th>
											</tr>
										<tr class="table100-head">
											<th class="sales_item17">사원번호</th>
											<th class="sales_item18">사원명</th>
										</tr>
									</thead>
									<tbody>
										<% 
											try{
												...
												/////////////////////////////////////////////////////////////////////////////
												//검색을 반영한 쿼리 적용
			                                    //salesQuery += " where 1=1 AND selling_chit_code is NOT NULL";
			                                    ...
			                                    if(code_search!=null && !code_search.equals("")) {
			                                    	salesQuery += " and item_code = '" + code_search + "'";
			                                    }
			                                    if(name_search!=null && !name_search.equals("전체")) {
			                                    	salesQuery += " and item_name = '" + name_search + "'";
			                                    }
			                                    /////////////////////////////////////////////////////////////////////////////
												...
												%>
													<tr>
													<td class="li_sales_item1"><%=i %></td>
													<td class="li_sales_item2"><%=SArs.getString("item_code")%></td>
													<td class="li_sales_item3"><%=SArs.getString("item_name")%></td>
													<td class="li_sales_item4"><%=SArs.getString("selling_chit_code")%></td>
													<td class="li_sales_item5"><%=SArs.getString("selling_date")%></td>
													<td class="li_sales_item6"><%=SArs.getString("employee_code")%></td>
													<td class="li_sales_item7"><%=SArs.getString("employee_name")%></td>
													<td class="li_sales_item8"><%=SArs.getString("customer_code")%></td>
													<td class="li_sales_item9"><%=SArs.getString("customer_name")%></td>
													<td class="li_sales_item10"><%=SArs.getString("item_unit_name")%></td>
													<td class="li_sales_item11"><% out.print(sellingCountDF);%></td>
													<td class="li_sales_item12"><% out.print(itemUnitPriceDF);%></td>
													<td class="li_sales_item13"><% out.print(supPriceDF);%></td>
													<td class="li_sales_item14"><% out.print(taxAmountDF);%></td>
													<td class="li_sales_item15"><% out.print(sellPriceDF);%></td>
													<td class="li_sales_item17"><%=SArs.getString("selling_memo")%></td>
											<% }
											}catch(SQLException ex){
												out.println(ex.getMessage());
												ex.printStackTrace();
								...
								<table style="background: #edf2fc;">
		                        	...
		                        	try{
		                                ...
		                                salesQuery = "select sum(s.selling_count*s.item_unit_price) as sup_price from selling s inner join item i on s.item_code = i.item_code where selling_chit_code is NOT NULL";
		                                ...
		                                if(code_search!=null && !code_search.equals("")) {
	                                    	salesQuery += " and s.item_code = '" + code_search + "'";
	                                    }
	                                    if(name_search!=null && !name_search.equals("전체")) {
	                                    	salesQuery += " and s.item_name = '" + name_search + "'";
	                                    }
		                                /////////////////////////////////////////////////////////////////////////////
		                                System.out.println(salesQuery);
	...
	$.datepicker.setDefaults({
	  ...
	  $( function() {
	    $( "#sale_list_datepicker_5, #sale_list_datepicker_6" ).datepicker();
	  } );
	 </script>
	 <script>
  		try{
    	...
    	$("#sale_total_data-submit-button").click(function() {
    		// select 된 값
    		optionSelect = $("select[name=item_name_search]").val();
    		console.log("select 값 : " + optionSelect);
    		
    		$("input[name=name_search_hidden]").attr('value', optionSelect);
		})
  		}catch (e) {
