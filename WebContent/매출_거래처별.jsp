...
<head>
    ...
    <title>GLASS 長 - 거래처별 매출 현황</title>
...
<body id="page-top" onload="noBack();" onpageshow="if(event.persisted) noBack();" onunload="">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                	<nav class="navbar navbar-dark bg-primary">
						<div class="container-fluid">
							<a class="navbar-brand mb-0 h1" href="#">거래처별 매출 현황</a>
						</div>
					</nav>
	            ...
	            String name_search = (String)request.getParameter("customer_name_search");
				...
				<!-- 검색창 -->
				<form action="매출_거래처별.jsp" method="POST">
				<div class="row mt-3 ml-1">
				    <div class="col-lg-3">
					    <div class="input-group">
					      <span class="mt-2"style="width:90px">거래처명</span>
					      <div class="input-group-btn m-1">
							 <select class="form-control ml-1" name="customer_name_search"" style="width:150px">
					    ...
					    <div class="input-group" style="width:600px">
					      ...
					      <div class="form-group mt-1"> 
						      <div class="input-group date mt-1 ml-2"> 
								<input type="text" name="source_datepicker_search" value="<%=sourcePicker_value %>" class="datepicker" style="width:175px" id="sale_list_datepicker_3"> 
						      </div> 
					      </div>
					      <span class="mt-1 ml-3">~</span>
					      <div class="form-group m-1"> 
						      <div class="input-group date mt-1 ml-2"> 
								<input type="text" name="destination_datepicker_search" value="<%=destinationPicker_value %>" class="datepicker" style="width:175px" id="sale_list_datepicker_4"> 
						      </div> 
					      </div>
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
							...
							<div class="wrap-table100">
								...
								<table>
									<thead>
										<tr class="table100-head">
											<th class="sales_account1" rowspan=2>No</th>
											<th class="sales_account2" rowspan=2>거래처<br>코드</th>
											<th class="sales_account3" rowspan=2>거래처명</th>
											<th class="sales_account4" rowspan=2>전표<br>번호</th>
											<th class="sales_account5" rowspan=2>매출일</th>
											<th class="sales_account6" colspan=2>담당자</th>
											<th class="sales_account7" rowspan=2>품목<br>코드</th>
											<th class="sales_account8" rowspan=2>품목명</th>
											<th class="sales_account9" rowspan=2>단위</th>
											<th class="sales_account10" rowspan=2>수량</th>
											<th class="sales_account11" rowspan=2>단가</th>
											<th class="sales_account12" rowspan=2>공급<br>가액</th>
											<th class="sales_account13" rowspan=2>세액</th>
											<th class="sales_account14" rowspan=2>매출액</th>
											<th class="sales_account16" rowspan=2>비고</th>
											</tr>
										<tr class="table100-head">
											<th class="sales_account17">사원번호</th>
											<th class="sales_account18">사원명</th>
										</tr>
									</thead>
									<tbody>
									<% 
	                                 try{
							            ...
							            if(name_search!=null && !name_search.equals("전체")) {
							            	salesQuery += " and customer_name = '" + name_search + "'";
							            }
							            /////////////////////////////////////////////////////////////////////////////
										...
										%>
											<tr>
											<td class="li_sales_account1"><%=i %></td>
											<td class="li_sales_account2"><%=SArs.getString("customer_code")%></td>
											<td class="li_sales_account3"><%=SArs.getString("customer_name")%></td>
											<td class="li_sales_account4"><%=SArs.getString("selling_chit_code")%></td>
											<td class="li_sales_account5"><%=SArs.getString("selling_date")%></td>
											<td class="li_sales_account6"><%=SArs.getString("employee_code")%></td>
											<td class="li_sales_account7"><%=SArs.getString("employee_name")%></td>
											<td class="li_sales_account8"><%=SArs.getString("item_code")%></td>
											<td class="li_sales_account9"><%=SArs.getString("item_name")%></td>
											<td class="li_sales_account10"><%=SArs.getString("item_unit_name")%></td>
											<td class="li_sales_account11"><% out.print(sellingCountDF);%></td>
											<td class="li_sales_account12"><% out.print(itemUnitPriceDF);%></td>
											<td class="li_sales_account13"><% out.print(supPriceDF);%></td>
											<td class="li_sales_account14"><% out.print(taxAmountDF);%></td>
											<td class="li_sales_account15"><% out.print(sellPriceDF);%></td>
											<td class="li_sales_account17"><%=SArs.getString("selling_memo")%></td>
									<% }
										}catch(SQLException ex){
											out.println(ex.getMessage());
											ex.printStackTrace();
								...
								<table style="background: #edf2fc;">
		                        	...
		                        	try{
		                                ...
		                                salesQuery = "select sum(s.selling_count*s.item_unit_price) as sup_price from selling s inner join customer c on s.customer_code = c.customer_code where selling_chit_code is NOT NULL";
	                                    ...
	                                    if(name_search!=null && !name_search.equals("전체")) {
	                                    	salesQuery += " and s.customer_name = '" + name_search + "'";
	                                    }
		                                /////////////////////////////////////////////////////////////////////////////
		                                System.out.println(salesQuery);
	...
	$.datepicker.setDefaults({
	  ...
	  $( function() {
	    $( "#sale_list_datepicker_3, #sale_list_datepicker_4" ).datepicker();
	  } );
	</script>
<script>
        try{
