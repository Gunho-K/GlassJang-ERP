...
<%
	String a = request.getParameter("item_code_hidden");
	System.out.println("item_code 는 : " + a);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<div class="row m-3">
				    <div class="col-lg-4">
					    <div class="input-group">
					      ...
					      <div class="input-group-btn">
							       <select class="form-control ml-1" name="customer_sales_category" style="width:150px">
					...
					<div class="col-lg-4">
					    <div class="input-group">
							<button type="button" class="btn btn-primary btn-sm" disabled="disabled" style="width:120px">
							  <span aria-hidden="true"></span>주소
							</button>
					      <div class="input-group-btn m-1">
					       	<input type="text" class="form-control-sm" name="customer_address" style="width:170px" aria-describedby="basic-addon2">
					      </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
					...
					<div class="col-lg-4">
					    <div class="input-group">
							<button type="button" class="btn btn-primary btn-sm" disabled="disabled" style="width:90px">
							  <span aria-hidden="true"></span>상호명
							</button>
					      <div class="input-group-btn m-1">
					       	<input type="text" class="form-control-sm" name="customer_name" style="width:170px" aria-describedby="basic-addon2">
					      </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
                </div>
                ...
                <div class="row m-3">
				    <div class="col-lg-4">
					    <div class="input-group">
					      ...
					      <div class="input-group-btn m-1">
					       	<input type="text" class="form-control-sm" name="customer_businessman_name" style="width:170px" aria-describedby="basic-addon2">
					      </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
					<div class="col-lg-4">
					    <div class="input-group">
					      ...
					      <div class="input-group-btn m-1">
					      	<input type="text" class="form-control-sm" name="customer_business_code" style="width:170px" aria-describedby="basic-addon2">
					      </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
					<div class="col-lg-4">
					    <div class="input-group">
					      ...
					      <div class="input-group-btn m-1">
					        <input type="text" class="form-control-sm" name="customer_business_man_phone" style="width:170px" aria-describedby="basic-addon2">
					      </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
                </div>
                ...
                <div class="row m-3">
				    <div class="col-lg-4">
					    <div class="input-group">
					      ...
					      <div class="input-group-btn m-1">
					       	<input type="text" class="form-control-sm" name="customer_type" style="width:170px" aria-describedby="basic-addon2">
					      </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
					<div class="col-lg-4">
					    <div class="input-group">
					      ...
					      <div class="form-group"> 
						      <div class="input-group date ml-1"> 
								<input type="text" class="datepicker" name="customer_first_registration" style="width:170px" id="store_first_datepicker_1"> 
						      </div> 
					      </div>
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
                ...
                <div class="row m-3">
				    <div class="col-lg-4">
					    <div class="input-group">
					      ...
					      <div class="input-group-btn m-1">
					       	<input type="text" class="form-control-sm" name="part_employee_name" aria-describedby="basic-addon2">
					      </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
					<div class="col-lg-4">
					    <div class="input-group">
					      ...
					      <div class="input-group-btn m-1">
					      	<input type="text" class="form-control-sm" name="part_employee_code" aria-describedby="basic-addon2">
					      </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
					<div class="col-lg-3">
					    <div class="input-group">
					      ...
					      <div class="input-group-btn m-1">
					      	<input type="text" class="form-control-sm" name="part_employee_phone" style="width:170px" aria-describedby="basic-addon2">
					      </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
                </div>
                ...
                <div class="row ml-3 mb-3">
				    <div class="col-lg">
					    <div class="input-group">
					      ...
					      <div class="input-group-btn m-1">
					       	<input type="text" class="form-control-lg" name="customer_memo" aria-describedby="basic-addon2"  style="width:1050px">
					      </div><!-- /btn-group -->
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-4 -->
                </div>
