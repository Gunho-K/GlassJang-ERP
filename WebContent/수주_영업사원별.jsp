...
<head>
    ...
    <title>GLASS 長 - 영업사원별 수주 현황</title>
...
<body id="page-top" onload="noBack();" onpageshow="if(event.persisted) noBack();" onunload="">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
	                ...
	                <nav class="navbar navbar-dark bg-primary">
						<div class="container-fluid">
							<a class="navbar-brand mb-0 h1" href="#">영업사원별 수주 현황</a>
						</div>
					</nav>
                	 <% 
            ...
            %>
				<!-- 검색창 -->
				<form action="수주_영업사원별.jsp" method="POST">
                ...
                <div class="row mt-2 ml-1">
					    ...
					    <div class="input-group" style="width:635px">
					      ...
					      <div class="form-group mt-1"> 
						      <div class="input-group date mt-1 ml-2"> 
								<input type="text" name="source_datepicker_search" value="<%=sourcePicker_value %>" class="datepicker" style="width:90%" id="order_list_datepicker_7"> 
						      </div> 
					      </div>
					      <span class="mt-1 ml-3">~</span>
					      <div class="form-group m-1"> 
						      <div class="input-group date mt-1 ml-2"> 
								<input type="text" name="destination_datepicker_search"  value="<%=destinationPicker_value %>" class="datepicker" style="width:90%" id="order_list_datepicker_8"> 
						      </div> 
					      </div>
					    </div><!-- /input-group -->
					</div><!-- /.col-lg-5 -->
					...
					<div class="col-lg-1">
					     <button type="submit" id="orders_total_data-submit-button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="margin-left:8px;">확인</button>
					</div><!-- /.col-lg-3 -->
                </div>
								...
								<table>
									<thead>
										<tr class="table100-head">
											<th class="order_emp1" rowspan="2">No</th>
											<th class="order_emp2" colspan="2">담당자</th>
											<th class="order_emp3" rowspan="2">품목<br>코드</th>
											<th class="order_emp4" rowspan="2">품목명</th>
											<th class="order_emp5" rowspan="2">거래처<br>코드</th>
											<th class="order_emp6" rowspan="2">거래처명</th>
											<th class="order_emp7" rowspan="2">단위</th>
											<th class="order_emp8" rowspan="2">수량</th>
											<th class="order_emp9" rowspan="2">단가</th>
											<th class="order_emp10" rowspan="2">수주<br>금액</th>
											<th class="order_emp11" rowspan="2">수주일</th>
											<th class="order_emp12" rowspan="2">수주<br>번호</th>
											<th class="order_emp13" rowspan="2">비고</th>
										</tr>
										<tr class="table100-head">
											<th class="order_emp14">사원번호</th>
											<th class="order_emp15">사원명</th>
										</tr>
                              ...
                              String yearMonthPicker = "";
                                       ...
                                       String order_date=""; // 수주일
											...
											try{
										        ...
										        //검색을 반영한 쿼리 적용
										        OrdersQuery =  "select * ";
										        OrdersQuery += " from orders o";
										        OrdersQuery += " inner join employee e on o.employee_code = e.employee_code";
										        OrdersQuery += " where order_memo !='취소'";
												 
										        
										        if(department_name != null && !department_name.equals("전체")) {
			                                    	OrdersQuery += " and e.employee_department = '" + department_name + "'";
			                                    }
			                                    ...
			                                    if(code_search!=null && !code_search.equals("")) {
			                                    	OrdersQuery += " and o.employee_code = '" + code_search + "'";
			                                    }
			                                    if(name_search!=null && !name_search.equals("")) {
			                                    	OrdersQuery += " and o.employee_name = '" + name_search + "'";
			                                    }
			                                    /////////////////////////////////////////////////////////////////////////////
	                                          ...
	                                          try{
	                                             ...
	                                             for(int i=0; i<count; i++){
	                                                ...
	                                                try{
	                                                   // 십의자리 배정시 비어있는 부분 패스
	                                                         ...
	                                                         OrdersQuery="select * from orders where order_memo!='취소'";
												...
												%>
													<tr id="trClick" data-toggle="modal" data-target="#OrderTrandingModal">
														<td class="li_order_emp1"><%=i %></td>
														<td class="li_order_emp14"><%=ORDERSrs.getString("employee_code")%></td>
														<td class="li_order_emp15"><%=ORDERSrs.getString("employee_name")%></td>
														<td class="li_order_emp3"><%=ORDERSrs.getString("item_code")%></td>
														<td class="li_order_emp4"><%=ORDERSrs.getString("item_name")%></td>
														<td class="li_order_emp5"><%=ORDERSrs.getString("customer_code")%></td>
														<td class="li_order_emp6"><%=ORDERSrs.getString("customer_name")%></td>
														<td class="li_order_emp7"><%=ORDERSrs.getString("item_unit_name")%></td>
														<td class="li_order_emp8"><% out.print(orderAmountDF); %></td>
														<td class="li_order_emp9"><% out.print(itemUnitPriceDF + "원"); %></td>
														<td class="li_order_emp10"><% out.print(orderpriceDF + "원"); %></td> <!-- 수주금액 -->
														<td class="li_order_emp11"><%=ORDERSrs.getString("order_date")%></td>
														<td class="li_order_emp12"><%=ORDERSrs.getString("order_code")%></td>
														<td class="li_order_emp13"><%=ORDERSrs.getString("order_memo")%></td>
											<%   } // while END
                                                           }   //try END   
	...
	$.datepicker.setDefaults({
	  ...
	  $( function() {
	    $( "#order_list_datepicker_7, #order_list_datepicker_8" ).datepicker();
	  } );
	 </script>
